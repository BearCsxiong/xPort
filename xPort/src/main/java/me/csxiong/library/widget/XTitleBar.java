...
import me.csxiong.library.utils.KeyboardConflictCompat;
...
public class XTitleBar extends RelativeLayout implements View.OnClickListener {
    ...
    private void loadAttributes(Context context, AttributeSet attrs) {
        PADDING_5 = XDisplayUtil.dpToPxInt(context, 5);
        PADDING_12 = XDisplayUtil.dpToPxInt(context, 12);
        ...
        titleBarHeight = (int) array.getDimension(R.styleable.XTitleBar_titleBarHeight, XDisplayUtil.dpToPxInt(context, 48));
        ...
        bottomShadowHeight = array.getDimension(R.styleable.XTitleBar_bottomShadowHeight, XDisplayUtil.dpToPxInt(context, 0));
        ...
        if (leftType == TYPE_LEFT_TEXTVIEW) {
            ...
            leftTextColor = array.getColor(R.styleable.XTitleBar_leftTextColor, getResources().getColor(R.color.comm_titlebar_text_selector));
            leftTextSize = array.getDimension(R.styleable.XTitleBar_leftTextSize, XDisplayUtil.dpToPxInt(context, 16));
            ...
            leftImageResource = array.getResourceId(R.styleable.XTitleBar_leftImageResource, R.drawable.comm_titlebar_reback_selector);
        ...
        if (rightType == TYPE_RIGHT_TEXTVIEW) {
            ...
            rightTextColor = array.getColor(R.styleable.XTitleBar_rightTextColor, getResources().getColor(R.color.comm_titlebar_text_selector));
            rightTextSize = array.getDimension(R.styleable.XTitleBar_rightTextSize, XDisplayUtil.dpToPxInt(context, 16));
        ...
        if (centerType == TYPE_CENTER_TEXTVIEW) {
            ...
            centerTextSize = array.getDimension(R.styleable.XTitleBar_centerTextSize, XDisplayUtil.dpToPxInt(context, 18));
            ...
            centerSubTextSize = array.getDimension(R.styleable.XTitleBar_centerSubTextSize, XDisplayUtil.dpToPxInt(context, 11));
        } else if (centerType == TYPE_CENTER_SEARCHVIEW) {
            centerSearchEdiable = array.getBoolean(R.styleable.XTitleBar_centerSearchEditable, true);
            centerSearchBgResource = array.getResourceId(R.styleable.XTitleBar_centerSearchBg, R.drawable.comm_titlebar_search_gray_shape);
    ...
    private void initGlobalViews(Context context) {
        ...
        // 计算主布局高度
        if (showBottomLine) {
            mainParams.height = titleBarHeight - Math.max(1, XDisplayUtil.dpToPxInt(context, 0.4f));
        } else {
        ...
        if (showBottomLine) {
            ...
            LayoutParams bottomLineParams = new LayoutParams(MATCH_PARENT, Math.max(1, XDisplayUtil.dpToPxInt(context, 0.4f)));
            ...
            LayoutParams bottomShadowParams = new LayoutParams(MATCH_PARENT, XDisplayUtil.dpToPxInt(context, bottomShadowHeight));
    ...
    private void initMainLeftViews(Context context) {
        ...
        if (leftType == TYPE_LEFT_TEXTVIEW) {
            ...
            tvLeft.setId(View.generateViewId());
            ...
            if (viewCustomLeft.getId() == View.NO_ID) {
                viewCustomLeft.setId(View.generateViewId());
            }
    ...
    private void initMainRightViews(Context context) {
        ...
        if (rightType == TYPE_RIGHT_TEXTVIEW) {
            ...
            if (viewCustomRight.getId() == View.NO_ID) {
                viewCustomRight.setId(View.generateViewId());
            }
    ...
    private void initMainCenterViews(Context context) {
        if (centerType == TYPE_CENTER_TEXTVIEW) {
            ...
            llMainCenter.setId(View.generateViewId());
            ...
            // 设置跑马灯效果
            tvCenter.setMaxWidth((int) (XDisplayUtil.getScreenPixelSize(context)[0] * 3 / 5.0));
            ...
            int progressWidth = XDisplayUtil.dpToPxInt(context, 18);
            ...
            // 设置边距
            centerParams.topMargin = XDisplayUtil.dpToPxInt(context, 7);
            centerParams.bottomMargin = XDisplayUtil.dpToPxInt(context, 7);
            ...
            ivSearch.setId(View.generateViewId());
            ivSearch.setOnClickListener(this);
            int searchIconWidth = XDisplayUtil.dpToPxInt(context, 15);
            ...
            ivVoice.setId(View.generateViewId());
            ...
            etSearchHint.setTextSize(TypedValue.COMPLEX_UNIT_PX, XDisplayUtil.dpToPxInt(context, 14));
            ...
            if (centerCustomView.getId() == View.NO_ID) {
                centerCustomView.setId(View.generateViewId());
            }
...
//            }
    ...
    public void showSoftInputKeyboard(boolean show) {
        if (centerSearchEdiable && show) {
            ...
            XDisplayUtil.showSoftInputKeyBoard(getContext(), etSearchHint);
        } else {
            XDisplayUtil.hideSoftInputKeyBoard(getContext(), etSearchHint);
        }
    }
