...
public final class XSpanUtils {
    ...
    private XSpanUtils(TextView textView) {
        this();
        mTextView = textView;
    }
     ...
     *             </ul>
     * @return the single {@link XSpanUtils} instance
     */
     ...
     * @return the single {@link XSpanUtils} instance
     */
    public XSpanUtils setLeadingMargin(@IntRange(from = 0) final int first,
     ...
     * @return the single {@link XSpanUtils} instance
     */
    public XSpanUtils setBullet(@ColorInt final int color,
     ...
     * @return the single {@link XSpanUtils} instance
     */
    public XSpanUtils setFontSize(@IntRange(from = 0) final int size, final boolean isSp) {
        this.fontSize = size;
     ...
     * @return the single {@link XSpanUtils} instance
     */
    public XSpanUtils setFontProportion(final float proportion) {
     ...
     * @return the single {@link XSpanUtils} instance
     */
    public XSpanUtils setFontXProportion(final float proportion) {
     ...
     * @return the single {@link XSpanUtils} instance
     */
    public XSpanUtils setHorizontalAlign(@NonNull final Alignment alignment) {
     ...
     * @return the single {@link XSpanUtils} instance
     */
    public XSpanUtils setVerticalAlign(@Align final int align) {
     ...
     * @return the single {@link XSpanUtils} instance
     */
    public XSpanUtils setBlur(@FloatRange(from = 0, fromInclusive = false) final float radius,
                              final Blur style) {
...
//            }
    ...
    static class CustomImageSpan extends CustomDynamicDrawableSpan {
        ...
        private CustomImageSpan(final Bitmap b, final int verticalAlignment) {
            ...
            mDrawable = new BitmapDrawable(APP.get().getResources(), b);
            mDrawable.setBounds(
        ...
        public Drawable getDrawable() {
            ...
            if (mDrawable != null) {
                ...
                try {
                    InputStream is =
                            APP.get().getContentResolver().openInputStream(mContentUri);
                ...
                try {
                    drawable = ContextCompat.getDrawable(APP.get(), mResourceId);
                    drawable.setBounds(
                            0, 0, drawable.getIntrinsicWidth(), drawable.getIntrinsicHeight()
                    );
                } catch (Exception e) {
...
//                    "lineHeight: " + (bottom - top));
    ...
    public static XSpanUtils with(final TextView textView) {
        return new XSpanUtils(textView);
    }
}