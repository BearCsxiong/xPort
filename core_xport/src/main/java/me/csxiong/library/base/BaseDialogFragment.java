...
import me.csxiong.library.integration.sys.OnCancelListenerDelegate;
import me.csxiong.library.integration.sys.OnDismissListenerDelegate;
 ...
 * <p>
 *     为了解决DialogFragment设置自身给Dialog造成的内存泄漏，拷贝了代码。
 * </p>
 */
public class BaseDialogFragment extends Fragment
     ...
     * used to showBottom an AlertDialog instead of a generic Dialog; when doing so,
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mDialog.setOnCancelListener(new OnCancelListenerDelegate(this));
        mDialog.setOnDismissListener(new OnDismissListenerDelegate(this));
        if (savedInstanceState != null) {
    ...
    public void onDestroyView() {
        super.onDestroyView();
        if (mDialog != null) {
            // Set removed here because this dismissal is just to hideAllBottom
