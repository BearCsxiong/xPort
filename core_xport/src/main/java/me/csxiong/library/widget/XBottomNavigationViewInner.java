...
public class XBottomNavigationViewInner extends BottomNavigationView {
    ...
    public XBottomNavigationViewInner(Context context) {
        this(context, null);
    }

    public XBottomNavigationViewInner(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XBottomNavigationViewInner(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        mMenuView.updateMenuView();
     ...
     * @param viewPager
     */
    public XBottomNavigationViewInner setupWithViewPager(final ViewPager viewPager) {
     ...
     */
    public XBottomNavigationViewInner setupWithViewPager(final ViewPager viewPager, boolean smoothScroll) {
        if (mViewPager != null) {
     ...
     * necessary calls back to the provided {@link XBottomNavigationViewInner} so that the tab position is
     * kept in sync.
     * <p>
    ...
    private static class BottomNavigationViewExOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<XBottomNavigationViewInner> mBnveRef;

        public BottomNavigationViewExOnPageChangeListener(XBottomNavigationViewInner bnve) {
        ...
        public void onPageSelected(final int position) {
            final XBottomNavigationViewInner bnve = mBnveRef.get();
...
//            Log.d("onPageSelected", "--------- position " + position + " ------------");
    ...
    private static class MyOnNavigationItemSelectedListener implements OnNavigationItemSelectedListener {
        ...
        MyOnNavigationItemSelectedListener(ViewPager viewPager, XBottomNavigationViewInner bnve, boolean smoothScroll, OnNavigationItemSelectedListener listener) {
